...
// Métodos de negócios.
void MostrarVeiculosEstacionados()
{
    Console.Clear();
...
void RegistrarEntradaMotocicleta()
{
...
void RegistrarEntradaAutomovel()
{
...
void ProcessarOpcaoMenu(string opcao)
{
    switch (opcao)
    {
        case "1":
