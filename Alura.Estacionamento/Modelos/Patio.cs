...
public class Patio
{
    ...
    public Veiculo AlteraDadosVeiculoPorPlaca(Veiculo veiculoAlterado)
    {
        Veiculo veiculoEstacionado = Veiculos.SingleOrDefault(x => x.Placa == veiculoAlterado.Placa);

        veiculoEstacionado.AlteraDadosVeiculoPorPlaca(veiculoAlterado);
